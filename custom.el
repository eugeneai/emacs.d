...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 ;; '(default ((t (:family "Fira Code" :foundry "CTDB" :slant normal :weight normal :height 210 :width normal))))
