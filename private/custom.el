...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "Source Code Pro Medium" :slant normal :weight normal :height 180 :width normal))))
...
'(line-number ((t (:background "black" :foreground "gold" :slant normal :weight normal :height 0.6 :family "Ubuntu Mono"))))
;; '(line-number ((t (:inherit (shadow default) :background "gray30" :foreground "gold" :weight ultra-light :family "Ubuntu Mono" :slant normal))))
